...
def schema_sanity_checks(full_df):
    ...
    print(f"\n  💾 Saved: {TABLES_DIR / 'schema_sanity_summary.csv'}")
...
def time_series_shape_analysis(full_df):
    ...
    print("\n" + "=" * 60)
    print("📈 Time Series Shape Analysis")
    print("=" * 60)
    ...
    plt.close()
    print(f"  ✅ Saved: {FIGURES_DIR / 'total_sales_over_time.png'}")
    ...
    plt.close()
    print(f"  ✅ Saved: {FIGURES_DIR / 'sales_by_store_type.png'}")
    ...
    plt.close()
    print(f"  ✅ Saved: {FIGURES_DIR / 'top_stores_by_sales.png'}")
    ...
    plt.close()
    print(f"  ✅ Saved: {FIGURES_DIR / 'top_depts_by_sales.png'}")
    ...
    plt.close()
    print(f"  ✅ Saved: {FIGURES_DIR / 'holiday_vs_nonholiday_dist.png'}")
    ...
    print("\n💰 Markdown Availability Analysis...")
    ...
    plt.close()
    print(f"  ✅ Saved: {FIGURES_DIR / 'markdown_availability.png'}")
...
def series_level_diagnostics(full_df):
    ...
    print("\n" + "=" * 60)
    print("🔬 Series-Level Diagnostics")
    print("=" * 60)
    
    # 1. Number of weeks per (store, dept)
    print("\n📅 Weeks Available per Store-Dept Combination...")
    ...
    plt.close()
    print(f"  ✅ Saved: {FIGURES_DIR / 'weeks_per_series_dist.png'}")
    ...
    series_stats['volatility_bucket'] = pd.cut(
        ...
        labels=['Low (CV<0.3)', 'Medium (0.3≤CV<0.6)', 'High (0.6≤CV<1.0)', 'Very High (CV≥1.0)']
    )
    ...
    plt.close()
    print(f"  ✅ Saved: {FIGURES_DIR / 'volatility_buckets.png'}")
...
def dashboard_ready_aggregates(full_df):
    ...
    print("\n" + "=" * 60)
    print("📊 Dashboard-Ready Aggregates")
    print("=" * 60)
    ...
    print(f"  ✅ Saved: {TABLES_DIR / 'dashboard_weekly_totals.csv'}")
    ...
    print(f"  ✅ Saved: {TABLES_DIR / 'dashboard_store_weekly.csv'}")
    ...
    print(f"  ✅ Saved: {TABLES_DIR / 'dashboard_dept_weekly.csv'}")
    ...
    print(f"  ✅ Saved: {TABLES_DIR / 'dashboard_top_depts_by_volume.csv'}")
    ...
    print(f"  ✅ Saved: {TABLES_DIR / 'dashboard_top_depts_by_volatility.csv'}")
